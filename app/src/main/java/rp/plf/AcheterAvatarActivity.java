...
public class AcheterAvatarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acheter_avatar);
        ...
        DatabaseReference usersRef = database.getReference("AvatarDispos");
    ...
    public void showAlertDialog(String prix, String lien){
        ...
        alert.setTitle("Achat d'avatar");
        alert.setMessage("Vous allez acheter l'avatar pour "+prix+" cristaux? Continuer ?");
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot userSnapshot : dataSnapshot.getChildren()) {
                            ...
                            if( Integer.parseInt(sousous)<Integer.parseInt(prix)){
                                Toast.makeText(AcheterAvatarActivity.this, "Solde insuffisant", Toast.LENGTH_SHORT).show();
                            }else{
                                if(!ban.contains(lien)){
                                    ban.add(lien);
                                    database.getReference("utilisateurs").child(user.getUid()).child("mesAvatars").setValue(ban);
                                    ...
                                    Toast.makeText(AcheterAvatarActivity.this, "Achat effectué avec succès ! L'avatar est consultable sur votre profil", Toast.LENGTH_SHORT).show();
                                    break;
                                }else{
                                    Toast.makeText(AcheterAvatarActivity.this, "Vous possédez déjà l'avatar", Toast.LENGTH_SHORT).show();
                                    break;
                                }
        ...
        alert.setNegativeButton("NON", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(AcheterAvatarActivity.this, "Achat annulé", Toast.LENGTH_SHORT).show();
            }
        });
        alert.create().show();
    }
