...
public class AjouterBanniereActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ajouter_banniere);
        ...
        button16.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String lien = editTextTextPersonName4.getText().toString();

                editTextNumber3 = findViewById(R.id.editTextNumber3);
                String prix =editTextNumber3.getText().toString();

                if (selectedRadioButtonId == -1) {
                    Toast.makeText(AjouterBanniereActivity.this, "Merci de choisir si c'est un avatar ou une bannière", Toast.LENGTH_SHORT).show();
                ...
                if(radioValue.equals("avatar")){
                    ...
                    DatabaseReference newChildRef = database.getReference("AvatarDispos");
                    newChildRef.child(monId).child("Lien").setValue(lien);
                    newChildRef.child(monId).child("Prix").setValue(prix);
                    Toast.makeText(AjouterBanniereActivity.this, "L'avatar a bien été ajouté pour "+prix+ " gemmes", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(getApplicationContext(),ModoActivity.class);
                    startActivity(intent);
                    finish();
                    ...
                    FirebaseDatabase database = FirebaseDatabase.getInstance();
                    String monId = generateRandomString();
                    DatabaseReference newChildRef = database.getReference("BanniereDispos");
                    newChildRef.child(monId).child("Lien").setValue(lien);
                    newChildRef.child(monId).child("Prix").setValue(prix);
                    Toast.makeText(AjouterBanniereActivity.this, "La bannière a bien été ajoutée pour "+prix+ " gemmes", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(getApplicationContext(),ModoActivity.class);
                    startActivity(intent);
                    finish();
                }
