...
public class AjouterHOF extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ajouter_hof);
        ...
        editTextTitre3 = findViewById(R.id.editTextTitre3);
        ...
        button18.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String saison = editTextTitre3.getText().toString();

                FirebaseDatabase database = FirebaseDatabase.getInstance();
                DatabaseReference newChildRef = database.getReference("HOF ");
                newChildRef.child("Saison"+saison).child("LienCarte").setValue(lien);
                newChildRef.child("Saison"+saison).child("Nom").setValue(nom);
                newChildRef.child("Saison"+saison).child("Saison").setValue(Integer.valueOf(saison));



                Toast.makeText(AjouterHOF.this, "Ajout à l'HOF OK", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(getApplicationContext(),ModoActivity.class);
                startActivity(intent);
                finish();
