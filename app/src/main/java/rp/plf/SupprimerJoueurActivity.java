...
public class SupprimerJoueurActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button16.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(SupprimerJoueurActivity.this, "Merci de contacter Vincent Aubert pour toute demande de suppression de compte", Toast.LENGTH_SHORT).show();
            }
        });
