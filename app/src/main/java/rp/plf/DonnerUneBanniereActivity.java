...
public class DonnerUneBanniereActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_donner_une_banniere);
        ...
        usersRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                contenuSpiner.remove("Plateau de la RPPLF");
        ...
        button17.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String lien = editTextTextPersonName5.getText().toString();
                RadioGroup radioGroup = findViewById(R.id.radioGroup);
                int selectedRadioButtonId = radioGroup.getCheckedRadioButtonId();
                if (selectedRadioButtonId == -1) {
                    Toast.makeText(DonnerUneBanniereActivity.this, "Merci de choisir si c'est un avatar ou une bannière", Toast.LENGTH_SHORT).show();
                    ...
                    query.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            for (DataSnapshot userSnapshot : dataSnapshot.getChildren()) {
                                ...
                                lesAvatarDeLUser.add(lien);
                                DatabaseReference mesAvatarsRef = userSnapshot.getRef().child("mesAvatars");
                                mesAvatarsRef.setValue(lesAvatarDeLUser);
                                Toast.makeText(DonnerUneBanniereActivity.this, "L'avatar a bien été ajouté à sa collection", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(getApplicationContext(),ModoActivity.class);
                                startActivity(intent);
                                finish();
                    ...
                    query.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            for (DataSnapshot userSnapshot : dataSnapshot.getChildren()) {
                                ...
                                Utilisateur utilisateur = userSnapshot.getValue(Utilisateur.class);
                                ArrayList<String> lesBans = new ArrayList<>();
                                lesBans.addAll(utilisateur.getMesBannieres());
                                lesBans.add(lien);
                                DatabaseReference mesAvatarsRef = userSnapshot.getRef().child("mesBannieres");
                                mesAvatarsRef.setValue(lesBans);
                                Toast.makeText(DonnerUneBanniereActivity.this, "La bannière a bien été ajoutée à sa collection", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(getApplicationContext(),ModoActivity.class);
                                startActivity(intent);
                                finish();
