...
public class CreerPublicationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_creer_publication);
    ...
    private void ajouterPost() {
        ...
        }else if(titre.getText().toString().contains("/") || titre.getText().toString().contains("*") || titre.getText().toString().contains("*")
        || titre.getText().toString().contains("[") || titre.getText().toString().contains("{")){
            Toast.makeText(this, "Caractère interdit", Toast.LENGTH_SHORT).show();
        }
        else{
            FirebaseDatabase database = FirebaseDatabase.getInstance();
            ...
            Publication publication = new Publication(stringTitre,auteur,contenuPost,image,"FUN",date);
