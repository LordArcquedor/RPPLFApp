...
public class PartagerReplayActivity extends AppCompatActivity {
    ...
    FirebaseAuth auth;
    Button validerButt;
    EditText nomEquipe,lien;
    String nomEquipeS,lienS;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_partager_replay);
        ...
        validerButt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(nomEquipeS.isEmpty() || lienS.isEmpty()){
                    Toast.makeText(PartagerReplayActivity.this, "Merci de remplir tout les champs", Toast.LENGTH_SHORT).show();
                }else{
                    ajouterReplayEnBase(nomEquipeS, lienS);
                }
            }
        });
...
//        runOnUiThread(thread);
    ...
    private void ajouterReplayEnBase(String nomEquipeS, String lienS) {
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference usersRef = database.getReference("ShodowmnMatch");
        MatchRP matchRP = new MatchRP(nomT.getText().toString(),nomEquipeS, lienS);
        String monId = generateRandomString();
        usersRef.child(monId).setValue(matchRP);
        Toast.makeText(this, "Match publié avec succès", Toast.LENGTH_SHORT).show();
        Intent intent = new Intent(getApplicationContext(), GestionAreneActivity.class);
        startActivity(intent);
        finish();
    }
